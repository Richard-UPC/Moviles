...
import com.aranibar.homeservice.viewcontrollers.models.Deallis;
...
public class DealsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Toast toast=Toast.makeText(getContext(),"Se insertó correctamente", Toast.LENGTH_SHORT);
        View vista=inflater.inflate(R.layout.fragment_deals, container, false);
